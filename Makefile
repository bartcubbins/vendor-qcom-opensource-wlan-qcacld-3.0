...
KBUILD_OPTIONS += CONFIG_CNSS_OUT_OF_TREE=1
KBUILD_OPTIONS += CONFIG_CNSS2=1
KBUILD_OPTIONS += CONFIG_CNSS2_QMI=1
KBUILD_OPTIONS += CONFIG_CNSS2_DEBUG=1
KBUILD_OPTIONS += CONFIG_CNSS_QMI_SVC=1
KBUILD_OPTIONS += CONFIG_CNSS_PLAT_IPC_QMI_SVC=1
KBUILD_OPTIONS += CONFIG_CNSS_GENL=1
KBUILD_OPTIONS += CONFIG_CNSS_UTILS=1
KBUILD_OPTIONS += CONFIG_CNSS2_SSR_DRIVER_DUMP=1
KBUILD_OPTIONS += CONFIG_WCNSS_MEM_PRE_ALLOC=1
